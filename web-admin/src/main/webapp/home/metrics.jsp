                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="list-group">
                            <c:forEach var="appId" items="${requestScope.applist}">
                            <a href="${grafana_url}/dashboard/script/sparkapp.js?appId=${appId}" class="list-group-item">
                               ${appId}
                            </a>
                            </c:forEach>
                        </div>
